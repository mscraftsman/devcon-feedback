<template>
    <v-container>
        <v-toolbar color="transparent" flat>
            ...
            <v-spacer></v-spacer>
            <v-btn mr-0 color="primary" :to="{name: 'feedbacksEdit', params:{id: 0}}">
        ...
        <v-alert type="info" value="true"  color="primary" outline icon="info" v-if="entities.length === 0">
            ...
            <v-btn :to="{name: 'feedbacksEdit', params:{id: 0}}" color="primary">create new</v-btn>
        </v-alert>
        <template v-else>
            ...
            <v-data-table :headers="headers" :items="entities" class="elevation-1" :search="search">
                <template slot="items" slot-scope="props">
                    ...
                    <td class="justify-center layout px-0">
                        <v-btn icon class="mx-0" :to="{name: 'feedbacksEdit', params: {'id': props.item.id}  }">
