...
func RegisterRoutes(router *mux.Router) {
	router.HandleFunc("/api/ratings/{id}", RestGet).Methods("GET")
	router.HandleFunc("/api/ratings", RestList).Methods("GET")
	router.HandleFunc("/api/ratings", RestCreate).Methods("POST")
	router.HandleFunc("/api/ratings/{id}", RestUpdate).Methods("PUT")
	router.HandleFunc("/api/ratings/{id}", RestDelete).Methods("DELETE")
}

//RestGet is a REST endpoint for GET /api/ratings/{id}
...
//RestList is a REST endpoint for GET /api/ratings
...
//RestCreate is a REST endpoint for POST /api/ratings
...
//RestUpdate is a REST endpoint for PUT /api/ratings/{id}
...
//RestDelete is a REST endpoint for DELETE /api/ratings/{id}
