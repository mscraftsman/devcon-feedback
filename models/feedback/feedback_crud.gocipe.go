...
func (entity *Feedback) Merge(tx *sql.Tx, autocommit bool) error {
	...
	*entity.CreatedAt = time.Now()
	...
	stmt, err := tx.Prepare(`INSERT INTO feedbacks (visitor_id, reaction_1, reaction_2, reaction_3, reaction_4, created_at) VALUES ($1, $2, $3, $4, $5, $6) 
	ON CONFLICT feedbacks_pkey UPDATE feedbacks SET visitor_id = $1, reaction_1 = $2, reaction_2 = $3, reaction_3 = $4, reaction_4 = $5, created_at = $6 WHERE id = $1`)
	if err != nil {
		return err
	}
