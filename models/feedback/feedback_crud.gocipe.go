...
func Get(id int64) (*Feedback, error) {
	...
	rows, err := db.Query("SELECT t.session_id, t.visitor_id, t.reaction_1, t.reaction_2, t.reaction_3, t.reaction_4, t.created_at FROM feedbacks t WHERE id = $1 ORDER BY t.id ASC", id)
	if err != nil {
		return nil, err
	}
	...
	for rows.Next() {
		...
		err := rows.Scan(entity.SessionID, entity.VisitorID, entity.Reaction1, entity.Reaction2, entity.Reaction3, entity.Reaction4, entity.CreatedAt)
		if err != nil {
			return nil, err
		}
...
func List(filters []models.ListFilter) ([]*Feedback, error) {
	...
	query := "SELECT t.session_id, t.visitor_id, t.reaction_1, t.reaction_2, t.reaction_3, t.reaction_4, t.created_at FROM feedbacks"
